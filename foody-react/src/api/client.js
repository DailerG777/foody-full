...
export const pedidosAPI     = { crear:(d)=>api.post('/pedidos',d), misPedidos:(p)=>api.get('/pedidos',{params:p}), ver:(id)=>api.get(`/pedidos/${id}`), actualizarEstado:(id,estado)=>api.put(`/pedidos/${id}/estado`,{estado}) };
