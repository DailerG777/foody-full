...
class ProductoController extends Controller {
    public function store(Request $request): JsonResponse {
        ...
        $data=$request->validate(['nombre'=>['required','string','max:120'],'descripcion'=>['nullable','string','max:300'],'precio'=>['required','integer','min:500'],'costo'=>['nullable','integer','min:0'],'menu_categoria_id'=>['nullable','exists:menu_categorias,id'],'emoji'=>['nullable','string','max:10'],'disponible'=>['sometimes','boolean'],'foto'=>['nullable','image','max:2048']]);
    ...
    public function update(Request $request,int $id): JsonResponse {
        ...
        $data=$request->validate(['nombre'=>['sometimes','string','max:120'],'descripcion'=>['sometimes','string','max:300'],'precio'=>['sometimes','integer','min:500'],'costo'=>['nullable','integer','min:0'],'emoji'=>['sometimes','string','max:10'],'disponible'=>['sometimes','boolean'],'foto'=>['sometimes','image','max:2048']]);
