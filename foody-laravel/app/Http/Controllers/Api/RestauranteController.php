...
class RestauranteController extends Controller {
    ...
    public function update(Request $request): JsonResponse {
        ...
        $data=$request->validate(['nombre'=>['sometimes','string','max:120'],'descripcion'=>['sometimes','string','max:500'],'categoria'=>['sometimes','string'],'telefono'=>['sometimes','string','max:20'],'whatsapp'=>['sometimes','string','max:20'],'nequi'=>['sometimes','string','max:20'],'daviplata'=>['sometimes','string','max:20'],'direccion'=>['sometimes','string','max:255'],'envio_gratis'=>['sometimes','boolean'],'envio_gratis_desde'=>['sometimes','integer','min:0'],'tiempo_min'=>['sometimes','integer','min:5','max:120'],'tiempo_max'=>['sometimes','integer','min:5','max:180'],'pedido_minimo'=>['sometimes','integer','min:0'],'abierto'=>['sometimes','boolean'],'foto_portada'=>['sometimes','image','max:4096'],'logo'=>['sometimes','image','max:2048'],'menu_pdf'=>['sometimes','file','mimes:pdf,jpeg,jpg,png','max:10240']]);
